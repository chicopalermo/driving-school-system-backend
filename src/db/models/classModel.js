...
export class ClassModel {
    ...
    static async getInstructorClasses(instructorId) {
        ...
        JOIN "car" ca ON cl."carId" = ca."carId"
        LEFT JOIN "user" u2 ON cl."studentId" = u2."userId"
        WHERE cl."instructorId" = 4 AND cl."studentId" IS NOT NULL AND cl."grades" IS NULL AND (cl."classDate" <= current_date at time zone 'UTC+1' AND cl."finishedAt" <= current_time at time zone 'UTC+3')
        ORDER BY cl."classDate"`;
